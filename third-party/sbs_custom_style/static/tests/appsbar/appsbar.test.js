...
import { appMenuService } from "@sbs_custom_style/appsbar/webclient/menus/app_menu_service";
...
test.tags("sbs_custom_style_appsbar");
test("SBS app menu service reorders apps based on user settings", async () => {
...
test.tags("sbs_custom_style_appsbar");
test("SBS app menu service selectApp calls menu.selectMenu", async () => {
    const tree = makeMenuTree([{
        id: 1,
        name: "Alpha",
        xmlid: "app.alpha",
