...
class ShareAction(models.TransientModel):
    ...
    def _onchange_partner_id(self):
        self.mobile_number = self.env[self._context.get('active_model')].browse(self.env.context.get('active_id')).partner_id.phone
    ...
    def action_send_whatsapp(self):
        if self.note and self.mobile_number:
            ...
            message_string = self.note + '%0a' + common_message + '%0a%0a' + urllib.parse.quote(self.share_link)
