...
export class CustomKanbanRenderer extends KanbanRenderer {
    ...
    AddClassStyle() {
        ...
        this.rootRef.el.classList.add('o_document_kanban_renderer');
        this.rootRef.el.parentElement.classList.add('o_component_with_workspace_panel');
    }
    Select_button_click(ev) {
        ...
        if (!this.eventListener) {
            this.rootRef.el.querySelectorAll('.kanban_document').forEach((selection_on_div) => {
