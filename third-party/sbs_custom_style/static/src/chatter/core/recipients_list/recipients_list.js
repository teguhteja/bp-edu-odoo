...
import { RecipientsListPopover } from '@sbs_custom_style/chatter/core/recipients_popover/recipients_popover';

export class RecipientsList extends Component {
    static template = 'sbs_custom_style.BaseRecipientsList';
    static props = {
        thread: { type: Object },
