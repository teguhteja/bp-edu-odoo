...
class TestColorAssetsEditor(TransactionCase):
    ...
    def setUpClass(cls):
        super().setUpClass()
        cls.editor = cls.env['sbs.custom.style.color.assets.editor']
        cls.light_url = '/sbs_custom_style/static/src/colors/scss/colors_light.scss'
    ...
    def test_theme_default_values(self):
        ...
        values = self.editor._get_color_variables(
            content,
            [
                'color_appsmenu_text',
                'color_appbar_text',
        ...
        self.assertEqual(values['color_appsmenu_text'], '#DEE2E6')
        self.assertEqual(values['color_appbar_text'], '#0A2540')
        self.assertEqual(values['color_appbar_active'], '#FFFFFF')
        self.assertEqual(values['color_appbar_background'], '#DEE2E6')
