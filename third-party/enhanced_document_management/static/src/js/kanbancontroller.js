...
patch(KanbanController.prototype, {
    ...
    _onSelectDocs(ev) {
         ...
         */
        const toast = this.rootRef.el.querySelector('.toast');
        const checkbox = ev.detail['event'];
        const record_id = parseInt(checkbox.dataset.id);
        if (checkbox.checked) {
            /**
             ...
             */
            checkbox.closest(".document_management_record")?.classList.add("selected");
            checkbox.closest(".document_table")?.classList.add("selected");
            checkbox.closest(".kanban_document")?.querySelector('.document_image')?.classList.add("selected");
            checkbox.closest(".kanban_document")?.classList.add("selected");
            checkbox.closest(".kanban_document")?.querySelector('.document_details')?.classList.add("selected");
             ...
             */
            checkbox.closest(".document_management_record")?.classList.remove("selected");
            checkbox.closest(".document_table")?.classList.remove("selected");
            checkbox.closest(".kanban_document")?.querySelector('.document_image')?.classList.remove("selected");
            checkbox.closest(".kanban_document")?.classList.remove("selected");
            checkbox.closest(".kanban_document")?.querySelector('.document_details')?.classList.remove("selected");
            const index = this.documents_selected.indexOf(record_id);
